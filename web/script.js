     $(document).ready(function(){
      ...
      $("#click").click(function(){
        document.getElementById("test").innerHTML = "You have clicked at: " + JSON.stringify(coords);
      });
     ...
     console.clear();
      ...
      const cardOptions = [
        {
          imageURL: {
            default: "https://images.unsplash.com/photo-1514483127413-f72f273478c3?ixlib=rb-1.2.1&ixid=MXwxMjA3fDB8MHxleHBsb3JlLWZlZWR8NHx8fGVufDB8fHw%3D&w=1000&q=80",
            hovered: "https://i.imgur.com/9mUz9we.png"
          },
          totalParticles: 1500,
          mouseRange: 50,
          particlesConfig: {
      ...
      class Particle {
        constructor(options = {}) {
          ...
          this.maxVelocity = options.maxVelocity || 80;
